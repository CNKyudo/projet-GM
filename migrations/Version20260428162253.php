 ...
 */
final class Version20260428162253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipment ADD nb_arcs INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipment ADD orientation VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE equipment ADD nb_fleches INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE equipment ADD accroche VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipment DROP nb_arcs');
        $this->addSql('ALTER TABLE equipment DROP orientation');
        $this->addSql('ALTER TABLE equipment DROP nb_fleches');
        $this->addSql('ALTER TABLE equipment DROP length');
        $this->addSql('ALTER TABLE equipment DROP weight');
        $this->addSql('ALTER TABLE equipment DROP accroche');
